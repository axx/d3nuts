...
myApp.controller('MyCtrl', ['$rootScope', '$scope', function($rootScope, $scope) {
  ...
  $rootScope.chartTitle = "Research Calls";
...
myApp.directive('donutChart', function() {
	function link(scope, el, attr) {
        ...
        var pie = d3.layout.pie().sort(null).startAngle(-Math.PI).endAngle(Math.PI);
        ...
        svg.append('text')
           ...
           .style('font-size', function(d) { return Math.min(parseInt(0.2 * window.innerHeight), 72) + "px"; });
        svg.append('text')
        ...
        scope.$watch('data', function(data){
          ...
          texts.attr("transform", function(d) {
                ...
                .attr("text-anchor", function(d) {
                  return (d.endAngle + d.startAngle)/2 > 0 ? "start" : "end";
                })
    ...
    return {
    	link: link,
    	restrict: 'E',
        scope: { data: '=', title:'=', center:'=', centersub:'='}
    };
});